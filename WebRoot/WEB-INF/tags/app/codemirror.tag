...
<%@ attribute name="autocomplete" required="false" %>	<e:description>自动补全，此属性与工具栏的自动补全快捷键公用</e:description>
...
<e:q4l var="sqlDataTypeList">
   select ID as "ID",NAME as "NAME" from X_REPORT_SQL_DATATYPE ORDER BY ORD 
</e:q4l>
...
<div style="float:left;" id="codeMirrorBottons">
	&nbsp;&nbsp;名称：<input type="text" id="datasetName" style="width:200px;"/>
	类型：<input style="width:70px" id="sqlDataType"  name="sqlDataType" class="easyui-combobox" 
					data-options='valueField:"ID", textField:"NAME",data: ${e:java2json(sqlDataTypeList.list)}'/>
...
<!--	codemirror参数-->
	...
	var options_${id} = {
		...
		,extraKeys: {
			<e:if condition="${autocomplete!=null}">
				"${autocomplete}": "autocomplete",//语法自动补全
			</e:if>
