...
<script type="text/javascript">
   ...
   $(function(){
		$("#combo_${id}").combobox({width:$("#combo_${id}").parent().width()-15});
...
<div id="dbLayout_${id}" class="easyui-layout" data-options="fit:true">
	 ...
	 <div data-options="region:'south',split:true,title:'表字段',collapsible:false" style="height:381px">
