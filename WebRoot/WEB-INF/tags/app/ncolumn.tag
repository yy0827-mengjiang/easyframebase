...
<%@ attribute name="dataPointClick" required="false" %>                               <e:description>点击柱图某块执行js方法，参数e</e:description>
...
<%@ attribute name="reversed" required="false" %>                                           <e:description>是否显示上下对比true or false</e:description>
