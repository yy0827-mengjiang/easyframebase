...
<e:q4o var="kpi" sql="kpi.formulaKpi.kpi">
</e:q4o>
<e:q4l var="formulaSub" sql="kpi.formulaKpi.formulaSub">
</e:q4l>
		...
		{   
			$.messager.alert('提示信息！', msg, 'info',function(){  
				if(flag!="1"){
					...
					$("#kpi").html('');
      			    $("#kpi").load('<e:url value="/pages/kpi/kpiManager/kpiMain.jsp"/>?kpi_category=&cube=${param.cubeCode}');
