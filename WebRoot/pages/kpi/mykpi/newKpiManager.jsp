...
<html>
  ...
  <script>
	  ...
	  $(function(){
		  $("#kpi").load('<e:url value="faileKpiList.e?kpi_key="/>${param.kpi_key}','',function(){});
		...
		<div data-options="region:'west',split:true" style="width:260px;padding:0px;">
				...
				<dl class="ddLine">
					<dd>
						<span class="first-child">
							<select id="cube_code1" disabled="disabled">
					...
					<dd style="width:100%;">
						<input class="inputBox" type="text" class="fromOne"  id="keywords_" style="width:200px"/>
			...
			<e:if condition="${managerFlag == 'manager' }" var="elseManager">
				<div class="easyui-tabs" style="width:258px;height:auto">
					 <div title="指标" style="padding:10px">
						 <ul id="tt"></ul>
					 </div>
					 <div title="维度" style="padding:10px">
						 <ul id="dim"></ul>
					 </div>
