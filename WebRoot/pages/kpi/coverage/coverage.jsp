...
<!-- 				<th field="KPI_VERSION" width="15%" align="left">指标版本</th> -->
	...
	<div id="dlg">
		<table>
			<tr>
				<td>指标编码：</td>
				<input type="hidden" id="eaction" name="eaction">
				<input type="hidden" id="usearea_id" name="usearea_id">
				<input type="hidden" id="kpi_code" name="kpi_code" value="${kpiInfo.KPI_CODE }">
				<td><input type="text" id="service_key" name="service_key" readonly="readonly" value="${kpiInfo.SERVICE_KEY }"></td>
			</tr>
			<tr>
				<td>指标名称：</td>
				<td><input type="text" id="kpi_name" name="kpi_name" readonly="readonly" value="${kpiInfo.KPI_NAME }"></td>
			</tr>
			<tr>
				<td>指标版本：</td>
				<td><input type="text" id="kpi_version" name="kpi_version" readonly="readonly" value="${kpiInfo.KPI_VERSION }"></td>
			</tr>
			<tr>
				<td>系统名称：</td>
				<td><input type="text" id="sys_name" name="sys_name"></td>
			</tr>
			<tr>
				<td>报表名称：</td>
				<td><input type="text" id="report_name" name="report_name"></td>
			</tr>
		</table>
	</div>
</body>
