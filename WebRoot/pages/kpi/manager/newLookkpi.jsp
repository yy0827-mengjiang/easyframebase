...
<body id="underLine">
	<div class="easyui-panel newAddkpi" title="新增指标">
		<div class="comOutBox">
			...
			<!--comInbox-->
			<div class="comInbox">
				<input type="hidden" id="kpiVersion" name="kpiVersion"
				...
				<dl class="group">
					...
					<dd>
						<input type="text" id="kpi_name0" name="kpi_name0" width="45%"
							...
							readonly="readonly"> <input type="hidden" id="isFormula"
							name="isFormula" value="1"> <span class="pl6">指标单位：</span><select
							id="kpi_unit0" name="kpi_unit0" value="${unit }"
				...
				<dl>
					<dt>指标公式：</dt>
					<dd>
						<div id="formKpi1" myAttr="formkpi1" class="formEdit"
							readOnly="readOnly">${fm }</div>
					</dd>
				</dl>
			</div>
			<!--//comInbox-->
			<div id="conditionDiv1" class="condDiv" " myAttr="condition"
			...
			<div>
				<input type="text" id="condition" name="condition"  placeholder="多个and之间请使用空格进行分格"
					style="width:100%" value="${cond }" disabled="disabled">
			</div>
			<div class="titOut">
				<h3>
					<span>指标口径、解释</span>
				...
				<dl class="group">
					...
					<dd>
						<textarea rows="3" id="kpiCalIber" name="kpiCalIber"
							style="width:100%;display: true">${kpiCalIber }</textarea>
					</dd>
				</dl>
				<dl class="group">
					<dt>指标解释：</dt>
					<dd>
						<textarea rows="3" id="kpiExplain" name="kpiExplain"
							style="width: 100%;display: true">${kpiExplain }</textarea>
					</dd>
				</dl>
			...
			<div div class="comInbox">
				<p class="titleSearch">
					指标提出人：<input type="text" id="kpiUser" name="kpiUser"
						value="${KPIUSER }" readonly="readonly"> 指标提出部门：&nbsp;<input
						type="text" id="kpiDept" name="kpiDept" value="${KPIDEPT }"
						readonly="readonly">
				</p>
				<p class="titleSearch">
					指标需求：
					<textarea rows="3" id="kpiFile" name="kpiFile"
						style="width: 80%;display: true">${KPIFILE }</textarea>
				<p>
			</div>
