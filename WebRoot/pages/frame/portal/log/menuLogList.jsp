...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function reflushDataGrid(){
				...
				$form.attr("action","<e:url value='/pages/frame/portal/log/menuLogList.jsp' />");
				$form.submit(); 
			}
		</script>
	</head>
	...
	<e:if condition="${param.loginDate1!=null&&param.loginDate1!=''&&param.loginDate1!='null'}">
		...
		<div id="tb">
			<form id="visitLogForm" method="post" name="visitLogForm"  action="">
				...
				<div class="search-area">
					开始日期:<c:datebox id="loginDate" name="loginDate" required="true" format="yyyymmdd" defaultValue='${loginDate_val}'/></dd>
					结束日期:<c:datebox id="loginDate1" name="loginDate1" required="true" format="yyyymmdd" defaultValue='${loginDate_val1}'/></dd>
		...
		<c:datagrid url="/pages/frame/portal/log/logAction.jsp?eaction=visitMenuLog&loginDate=${loginDate_val}&loginDate1=${loginDate_val1}" id="visitLogListTable" pageSize="${Number_val }" download="菜单访问排名" fit="true" border="false"  toolbar="#tb">
			<thead>
				<tr>
