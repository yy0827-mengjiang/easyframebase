...
<html>
	...
	<body> 		
	<div style="height:100%; width:49.5%; float:left; border-right:1px solid #ddd">
			<div id="tb1">
			...
			<c:datagrid url="/pages/frame/portal/role/RoleAction.jsp?eaction=getHasSelectUsers&currentNodeId=${param.currentNodeId }" id="hasSelectUsersTable" pageSize="10"  fit="true" title="" toolbar="#tb1">
				<thead>
					<tr>
						<th field="LOGIN_ID" width="200">
							登陆ID
						</th>
		...
		<div style="height:100%; width:50%; float:left;">
			<div id="tb2">
				<form id="loginLogForm" method="post" name="loginLogForm"  action="">
					<h2>未选择的用户</h2>
					<div class="search-area">
							登陆ID:<input id="loginIdForNeedSelect"  type="text" name=""loginIdForNeedSelect"" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 80px"></dd>
							用户姓名:<input id="userNameForNeedSelect" type="text" name="userNameForNeedSelect" value="" class="easyui-validatebox" validType="length[0,100]" style="width: 80px"></dd>
							<a href="javascript:void(0);" class="easyui-linkbutton" onclick="doQueryForNeedSelect()">查询</a>
					</div>
				</form>
			</div>
			<c:datagrid url="/pages/frame/portal/role/RoleAction.jsp?eaction=getNeedSelectUsers&currentNodeId=${param.currentNodeId }" id="needSelectUsersTable" pageSize="5" border="false" fit="true" title=""  toolbar="#tb2">
				<thead>
					<tr>
						<th field="LOGIN_ID" width="200">
							登陆ID
