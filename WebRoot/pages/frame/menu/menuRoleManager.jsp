	...
	<head>
		...
		<script type="text/javascript">
			...
			function deleteRole(roleCode){
				...
				$.post('<e:url value="/pages/frame/menu/menuAction.jsp?eaction=removeRole"/>', params, function(data){
					if($.trim(data)>0){
			...
			function addRole(roleCode){
				...
				$.post('<e:url value="/pages/frame/menu/menuAction.jsp?eaction=addRole"/>', params, function(data){
	             	if($.trim(data)=='1'){
	             		$('#hasSelectRolesTable').datagrid("load",$("#hasSelectRolesTable").datagrid("options").queryParams);
	             		$('#needSelectRolesTable').datagrid("load",$("#needSelectRolesTable").datagrid("options").queryParams);
	             	}else{
	...
	<table>
		<tr>
			<td>
				<div id="tb1">
					<form id="loginLogForm" method="post" name="loginLogForm" style="display: inline;" action="">
						<div class="topListUser">
							<dl>
								<dt>角色编码:</dt>
								<dd><input id="roleIdForHasSelect"  type="text" name="roleIdForHasSelect" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 80px"></dd>
								<dt>角色名称:</dt>
								<dd><input id="roleNameForHasSelect" type="text" name="roleIdForHasSelect" value="" class="easyui-validatebox" validType="length[0,100]" style="width: 80px"></dd>
							</dl>
							<p>
				...
				<c:datagrid url="/pages/frame/menu/menuAction.jsp?eaction=getHasSelectRoles&currentNodeId=${param.currentNodeId }" id="hasSelectRolesTable" pageSize="10"  style="width:505px;height:400px;" title="已选择的角色" toolbar="#tb1">
					<thead>
						<tr>
							<th field="ROLE_CODE" width="80">
								角色编码
							</th>
							<th field="ROLE_NAME" width="120">
								角色名称
							</th>
							<th field="MEMO" width="120"> 
								角色描述
							</th>
							<th field="QX" width="120"> 
								权限
							</th>
			...
			<td>
				<div id="tb2">
					<form id="loginLogForm" method="post" name="loginLogForm" style="display: inline;" action="">
						<div class="topListUser">
							<dl> 
								<dt>角色编码:</dt>
								<dd><input id="roleIdForNeedSelect"  type="text" name=""roleIdForNeedSelect"" value="" class="easyui-validatebox" validType="length[0,30]" style="width: 80px"></dd>
								<dt>角色名称:</dt>
								<dd><input id="roleNameForNeedSelect" type="text" name="roleNameForNeedSelect" value="" class="easyui-validatebox" validType="length[0,100]" style="width: 80px"></dd>
							</dl>
							<p>
				...
				<c:datagrid url="/pages/frame/menu/menuAction.jsp?eaction=getNeedSelectRoles&currentNodeId=${param.currentNodeId }" id="needSelectRolesTable" pageSize="5" style="width:505px;height:400px;" title="未选择的角色"  toolbar="#tb2">
					<thead>
						<tr>
							<th field="ROLE_CODE" width="80">
								角色编码
							</th>
							<th field="ROLE_NAME" width="160">
								角色名称
							</th>
							<th field="MEMO" width="160"> 
								角色描述
							</th>
							<th field="QX" width="120" formatter="formatterQX"> 
								权限选择
							</th>
