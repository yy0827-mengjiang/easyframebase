...
<e:q4l var="usersComperThreeMel">
		<e:if condition="${e:length(selectifa3.list)>10}">
		SELECT 
				'10' "MEL_NO",
			  '其他' "MEAL_NAME",
				A.a-B.a a
...
<e:q4l var="usersComperOneHy">
		<e:if condition="${e:length(selectifb1.list)>10}">
		SELECT '10' "MEL_NO",
			   '其他' "MEAL_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperTwoHy">
		<e:if condition="${e:length(selectifb2.list)>10}">
		SELECT '10' "MEL_NO",
			   '其他' "MEAL_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperThreeHy">
		<e:if condition="${e:length(selectifb3.list)>10}">
		SELECT '10' "MEL_NO",
			   '其他' "MEAL_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperOneApp">
		<e:if condition="${e:length(selectc1.list)>10}">
		SELECT '10' "APP_NO",
			   '其他' "APP_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperTwoApp">
	<e:if condition="${e:length(selectc2.list)>10}">
		SELECT '10' "APP_NO",
			   '其他' "APP_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperThreeApp">
	<e:if condition="${e:length(selectc3.list)>10}">
		SELECT '10' "APP_NO",
			   '其他' "APP_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperOneArpu">
	<e:if condition="${e:length(selectd1.list)>10}">
		SELECT 
			'10' "ARPU_NO",
			 '其他' "RPU_NAME",
			 A.a-B.a a
...
<e:q4l var="usersComperTwoArpu">
	<e:if condition="${e:length(selectd2.list)>10}">
		SELECT 
			'10' "ARPU_NO",
			 '其他' "RPU_NAME",
			 A.a-B.a a
...
<e:q4l var="usersComperThreeArpu">
	<e:if condition="${e:length(selectd3.list)>10}">
		SELECT 
			'10' "ARPU_NO",
			 '其他' "RPU_NAME",
			 A.a-B.a a
     ...
     <div id="compareOne">
					<div class="AdminProduct">
						...
						<div  class="overflow-h">
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperThreeAge.list)>0}" var="check3">			 	
								<c:npie  id='pie31' 
										 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname3 }-${param.brxhname3 }"
									 	 dataLabels="false"	 							
										 items="${usersComperThreeAge.list}"
										 a="占比"
										 dimension="AGE_NAME"
										 tipfmt="2"
										 legend="true"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneSex.list)>0}" var="check4">
								<c:npie  id='pie12' 
										 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperTwoSex.list)>0}" var="check5">			 
								<c:npie  id='pie22' 
										 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname2 }-${param.brxhname2 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperThreeSex.list)>0}" var="check6">			 
								<c:npie  id='pie32' 
										 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname3 }-${param.brxhname3 }"
									 	 dataLabels="false"	 							
										 items="${usersComperThreeSex.list}"
										 a="占比"
										 dimension="SEX"
										 tipfmt="2"
										 legend="true"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneMel.list)>0}" var="check7">
								<c:npie  id='pie13' 
										 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperTwoMel.list)>0}" var="check8">			 
								<c:npie  id='pie23' 
										width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname2 }-${param.brxhname2 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperThreeMel.list)>0}" var="check9">			 
								<c:npie  id='pie33' 
										 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname3 }-${param.brxhname3 }"
									 	 dataLabels="false" 							
										 items="${usersComperThreeMel.list}"
										 a="占比"
										 dimension="MEAL_NAME"
										 tipfmt="2"
										 legend="true"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">							
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneHy.list)>0}" var="check10">
								<c:npie  id='pie14' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperTwoHy.list)>0}" var="check11">		 	
								<c:npie  id='pie24' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname2 }-${param.brxhname2 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperThreeHy.list)>0}" var="check12">		 
								 <c:npie  id='pie34' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname3 }-${param.brxhname3 }"
									 	 dataLabels="false" 							
									 items="${usersComperThreeHy.list}"
									 a="占比"
									 dimension="MEAL_NAME"
									 tipfmt="2"
									 legend="true"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">							
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneApp.list)>0}" var="check13">
								<c:npie  id='pie15' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
							...
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperTwoApp.list)>0}" var="check14">		 
								<c:npie  id='pie25' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname2 }-${param.brxhname2 }"
							...
							<e:else condition="${check14}">
								 暂无数据！
							</e:else>
							</div>	
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperThreeApp.list)>0}" var="check15">		 	 
								<c:npie  id='pie35' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname3 }-${param.brxhname3 }"
									 	 dataLabels="false" 							
									 items="${usersComperThreeApp.list}"
									 a="占比"
									 dimension="APP_NAME"
									 tipfmt="2"
									 legend="true"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneArpu.list)>0}" var="check16">
								<c:npie  id='pie16' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
							...
							<e:else condition="${check16}">
								 暂无数据！
							</e:else>
							</div>	
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperTwoArpu.list)>0}" var="check17">		 	
								<c:npie  id='pie26' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname2 }-${param.brxhname2 }"
							...
							<e:else condition="${check17}">
								 暂无数据！
							</e:else>
							</div>	
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperThreeArpu.list)>0}" var="check18">		 	
								 <c:npie  id='pie36' 
									 width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname3 }-${param.brxhname3 }"
									 	 dataLabels="false" 							
									 items="${usersComperThreeArpu.list}"
									 a="占比"
									 dimension="ARPU_NAME"
									 tipfmt="2"
									 legend="true"
