...
<e:q4l var="usersComperOneMel">
	<e:if condition="${e:length(selectifa.list)>10}">
		SELECT 
				'10' "MEL_NO",
			  '其他' "MEAL_NAME",
				A.a-B.a a
...
<e:q4l var="usersComperOneHy">
	<e:if condition="${e:length(selectifb.list)>10}">
		SELECT '10' "MEL_NO",
			   '其他' "MEAL_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperOneApp">
	<e:if condition="${e:length(selectc.list)>10}">
		SELECT '10' "APP_NO",
			   '其他' "APP_NAME",
			   A.a-B.a a
		FROM
...
<e:q4l var="usersComperOneArpu">
	<e:if condition="${e:length(selectd.list)>10}">
		SELECT 
			'10' "ARPU_NO",
			 '其他' "RPU_NAME",
			 A.a-B.a a
  ...
  <body>
     <div id="compareOne">
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">
							<div class="chartAdmin">
								<e:if condition="${e:length(usersComperOneSex.list)>0}" var="check2">  							
								<c:npie  id='pie12' 
										  width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneMel.list)>0}" var="check3"> 
								<c:npie  id='pie13' 
										  width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">							
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneHy.list)>0}" var="check4">
								<c:npie  id='pie14' 
									  	width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">							
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneApp.list)>0}" var="check5">
								<c:npie  id='pie15' 
									  	width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
					...
					<div class="AdminProduct">
						...
						<div class="overflow-h">
							<div class="chartAdmin">
							<e:if condition="${e:length(usersComperOneArpu.list)>0}" var="check6">
								<c:npie  id='pie16' 
									 	width='400'
									 	 height='350' 									 	 
									 	 title="${param.brname1 }-${param.brxhname1 }"
