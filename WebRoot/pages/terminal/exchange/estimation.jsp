      ...
      $(function(){
         ...
         change(1);
           ...
           function doSearch(){   	      	  
       		...
       		window.location.href='<e:url value='/pages/terminal/exchange/estimation.jsp'/>?area_no='+area_no+'&city_no='+city_no;	
...
<body>
	<div id="boncEntry">
		...
		<!-- 市场预估 -->
		<div class="userarea">
			<div class="exchangebox market" style="width: 70%;">
				<h2>三级市场（销量）</h2>
				<span><a class="hspan" href="javascript:void(0)"
					onclick="change(1)">战略机型</a></span> <span><a class="hspan"
					href="javascript:void(0)" onclick="change(2)">特色终端</a></span> <span><a
					class="hspan" href="javascript:void(0)" onclick="change(3)">合作品牌</a></span>
				<!-- charts图表预留位置 -->
				<div class="charts" id="sanji" style="width: 940px; height: 435px;">
			...
			<div class="userbox" style="width: 29%;">
				...
				暂无数据
					...
					<e:else condition="${list5 }">
						<c:npie id="heyue1" distance = "3" width="410" height="203px" showexport="false"
							title="" unit="" terminal_num="数量" dimension="cuntract_name"
							percentage="false" tipfmt="1" items="${heyue.list}" />
					</e:else>
				</div>
				<!-- //charts图表预留位置 -->
			</div>
			<div class="userbox" style="width: 41%;">
				...
				暂无数据
					...
					<e:else condition="${list6 }">
						<c:ncolumnline id="columnline" width="416px" height="185"
							yaxis="title:,unit:"
							colors="['#01d6ff','#fff','#ffcf13','#86d438','#8945fe']"
							showexport="false" terminal_num="name:ARPU值,type:column"
							dimension="arpu_name" items="${arpu.list}" title=" "
							legend="false" dataLabel="true" fontsize="10px" rotation="0" />
					</e:else>
				</div>
				<!-- //charts图表预留位置 -->
