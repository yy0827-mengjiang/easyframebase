var detailview = $.extend({}, $.fn.datagrid.defaults.view, {
	...
	renderRow: function(target, fields, frozen, rowIndex, rowData){
		...
		for(var i=0; i<fields.length; i++){
			...
			if (col){
				...
				var displayStr = '';
				if(opts.expandeHidden==true && field=='_expander'){
					displayStr = 'style="display:none"';
				}
				cc.push('<td '+displayStr+' field="' + field + '" ' + cls + ' ' + style + '>');
				...
				if (col.checkbox){
					...
					cc.push('<div style="text-align:center;width:16px;height:16px;"><span class="datagrid-row-expander datagrid-row-expand" style="display:none;" />');
	...
	onBeforeRender: function(target){
		...
		if (!hasExpander){
			...
			var displayStr = '';
			if(opts.expandeHidden==true){
				displayStr = 'style="display:none"';
			}
			var td = $('<td '+displayStr+' rowspan="'+opts.frozenColumns.length+'"><div class="datagrid-header-expander" style="width:24px;"></div></td>');
			if ($('tr',t).length == 0){
