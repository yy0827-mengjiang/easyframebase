...
$.fn.layout.paneldefaults=$.extend({},$.fn.panel.defaults,{region:null,split:false,collapsedSize:36,expandMode:"float",hideExpandTool:false,hideCollapsedContent:true,collapsedContent:function(_402){
var p=$(this);
...
if(isclicked1){
	setTimeout(function(){opts.onSelect.call(_a48,row)},100);
	isclicked1=false;
}
