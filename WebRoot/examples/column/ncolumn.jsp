...
<div class="exampleWarp" style="overflow:hidden;">
	<h1 class="titOne">柱图<em>c:ncolumn</em></h1>
	...
	<c:ncolumn id="COLUMN1" width="490" height="400"
			yaxis="title:一轴,unit:单位;title:二轴,unit:单位,color:#AA4643"
			A="name:指标1,type:column" B="name:指标二,yaxis:1,type:column"
			C="name:指标三,yaxis:1,type:column" dimension="AREA_NO"
			url="/examples/nchart_action.jsp?eaction=ncolumn" title="柱图"
			dataPointClick="dataPointClick"
			colors="['#01d6ff','#ff8500','#ffcf13','#86d438','#8945fe','#01d6ff','#ff8500','#ffcf13','#86d438','#8945fe']" />
	<h1 class="titTwo"> 同步数据集方法实现 </h1>
	<c:ncolumn id="COLUMN2" width="490" height="400"
			yaxis="title:一轴,unit:单位;title:二轴,unit:单位,color:#AA4643"
			A="name:指标1,type:column" B="name:指标二,yaxis:1,type:column"
			C="name:指标三,yaxis:1,type:column" dimension="AREA_NO"
			items="${testList.list}" title="柱图"
			colors="['#01d6ff','#ff8500','#ffcf13','#86d438','#8945fe','#01d6ff','#ff8500','#ffcf13','#86d438','#8945fe']" />
	<h1 class="titTwo">堆积方法实现 </h1>
	<c:ncolumn id="COLUMN3" width="490" height="400"
			yaxis="title:一轴,unit:单位;title:二轴,unit:单位,color:#AA4643"
			A="name:指标1,type:column" B="name:指标二,yaxis:1,type:column"
			C="name:指标三,yaxis:1,type:column" dimension="AREA_NO"
			items="${testList.list}" title="柱图" stacking="true"
			colors="['#01d6ff','#ff8500','#ffcf13','#86d438','#8945fe','#01d6ff','#ff8500','#ffcf13','#86d438','#8945fe']" show3D="true" alpha="15" beta="15"/>
