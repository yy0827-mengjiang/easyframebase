...
<e:switch value="${param.eaction}">
	<e:case value="loadDim">
		<a:treegridquery dimField="all">
			select '合计' V0, '' ID, sum(VALUE1) V1,sum(VALUE2) V2,sum(VALUE3) V3 from E_COMPONENT_EXAMPLE t 
		</a:treegridquery>
		
		<a:treegridquery dimField="area">
		...
		<a:treegridquery dimField="day">
			select t.acct_day V0, t.acct_day ID,sum(VALUE1) V1,sum(VALUE2) V2,sum(VALUE3) V3 from E_COMPONENT_EXAMPLE t where 1=1
			<e:if condition="${param.area ne '' && param.area != null}">
			and t.area_no='${param.area}'
			</e:if>
			<e:if condition="${param.city ne '' && param.city != null}">
