...
public class DownQueueBigData {
	...
	static{
		if(EasyContext.getContext().get("maxBigDataThreadNum")!=null){
			maxTaskNum=Integer.parseInt(String.valueOf(EasyContext.getContext().get("maxBigDataThreadNum")));
		}
	}
	/*
	 * 描述：获取全部队列
